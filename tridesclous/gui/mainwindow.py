...
class MainWindow(QT.QMainWindow):
    ...
    def create_actions_and_menu(self):
        ...
        do_init = QT.QAction('&Initialize', self, shortcut = "Ctrl+I")
        do_init.triggered.connect(self.initialize_dialog)
    ...
    def initialize_dialog(self):
        ...
        init_dia = InitializeWindow(parent=self)
        
        if init_dia.exec_():
            try:
                p = init_dia.final_params
                dirname = p['dirname']
...
class InitializeWindow(QT.QDialog):
