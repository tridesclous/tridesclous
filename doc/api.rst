...
Almost everything can be done 3 classes:
  * :class:`DataIO` for confiuration of the dataset, format selection, PRB file assignement, ...
  * :class:`CatalogueConstructor` run all step to construct the catalogue : signal processing, fetaure, clustering, ...
